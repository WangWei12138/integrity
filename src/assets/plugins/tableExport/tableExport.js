          ...
          if ( cell !== null ) {
            ...
            if ( defaults.type == 'tsv' ) {
              ...
              if ( dataString instanceof Date )
                ...
                // 	if(childs.length==1){
                // 		var imgNode = childs[0];
                // 		var srcPath = imgNode.src;
                // 		var ganIndex = srcPath.lastIndexOf("/");
                // 		var dashIndex = srcPath.lastIndexOf(".");
                // 		var imgStyle = srcPath.substring(ganIndex+1,dashIndex);
                // 		result = imgStyle;
                // 	}
                // }
              }
